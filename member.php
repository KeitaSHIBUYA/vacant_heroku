...
<div id="container">
	...
	<div id="contents">
		<div id="contents-in">
			<div id="main">
				<section>
					...
					<table class="ta1">
						<tr>
							<th colspan="2" class="tamidashi">担当教員</th>
						</tr>
						<tr>
							<th>情報連携学部</th>
							<td>別所 正博</td>
					...
					<table class="ta1">
						<tr>
							<th colspan="2" class="tamidashi">情報連携実習III グループ8 チーム4</th>
						</tr>
						<tr>
							<th>1F10180284</th>
							<td>渋谷 敬大</td>
		...
		<div id="side">
			...
			<p> <a href="member.html"><img src="images/banner1.jpg" alt="採用情報" class="pc"></a> <a href="member.html"><img src="images/banner1_sh.jpg" alt="採用情報" class="sh"></a> </p>
			<p>上のバナー画像は、801px以上の端末と800px以下とで画像２種類が切り替わります。<br>
				<a href="process.html#banner">詳しい説明はこちら。</a></p>
			<div>
				<h2>ボックスの外も</h2>
