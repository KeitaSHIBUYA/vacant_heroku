...
<div id="container">
		...
		<div id="contents-in">
			<div id="main">
				<section id="new">
					...
					<dl>
						<dt>2021/11/03</dt>
						<dd>サイトバーを実装。<span class="newicon">NEW</span></dd>
						<dt>2021/10/30</dt>
						<dd>ヘッダーとフッターをカスタマイズした。</dd>
						<dt>2021/10/25</dt>
						<dd>「ホーム」「更新」「過程」「メンバー」「参考」「物件一覧」のページを作成した。</dd>
						<dt>2021/10/20</dt>
						<dd>申し込みボタンの作成。</dd>
						<dt>2021/10/15</dt>
						<dd>ロゴを作成しウェブサイトに実装。</dd>
						<dt>2021/10/10</dt>
						<dd>デモサイトの枠組みが完成。</dd>
						<dt>2021/10/05</dt>
						<dd>メンバー全員にxamppをインストールさせ、ローカルサーバー環境を構築した。<a href="https://gitlab.com/s1f101802847/demosite" target="_blank" rel="noopener noreferrer">gitlab</a>を用いてプロジェクトを管理する。</dd>
						<dt>2021/10/03</dt>
						<dd>簡単なサイトモデルを決定。暫定プロジェクトネームを「Vacant」に決定。</dd>
						<dt>2021/10/01</dt>
						<dd>制作物としてローカル環境で動くデモサイトを作成することに決定。</dd>
						<dt>2021/07/22</dt>
						<dd>参考にするサイトを<a href="https://www.rental-o.com/" target="_blank" rel="noopener noreferrer">レンタルオフィス.com</a>にｎ定。</dd>
						<dt>2021/07/15</dt>
						<dd>テーマカラーをライトブルーに決定。</dd>
						<dt>2021/07/08</dt>
						<dd>メンバーとどんなサイトにするかを検討。</dd>
						<dt>2021/07/01</dt>
						<dd>INIAD講義「情報連携実習III」にてグループ作成。</dd>
					</dl>
    ...
    <div id="side">
      ...
      <p> <a href="recruit.html"><img src="images/banner1.jpg" alt="採用情報" class="pc"></a> <a href="recruit.html"><img src="images/banner1_sh.jpg" alt="採用情報" class="sh"></a> </p>
