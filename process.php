		...
		<div id="contents-in">
			<div id="main">
				<section>
					<h2>プロジェクト実行過程</h2>
					<div class="g-slide">
						<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vS96wEl8CiBi3bhLFVwdsTpvHY-UgAkT51TGRxIa-6oC1dLOYVVNQKIDlH_pSsR5f9nBfcyWwzfvpBy/embed?start=false&loop=false&delayms=3000" frameborder="0" width="" height="" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
					</div>
				</section>
			</div>
			<!--/#main-->
